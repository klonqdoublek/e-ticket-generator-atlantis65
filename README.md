# E-Ticket Generator : Tapadkarnlakorn'65 The Atlantis
...
1. Clone the repository:
   ```bash
   git clone https://github.com/klonqdoublek/e-ticket-generator-atlantis65.git
   ```
2. Navigate to the project directory:
   ```bash
   cd e-ticket-generator-atlantis65
   ```
...
## Contact
For inquiries or feedback, please reach out to [pichaya.phulphean@gmail.com](mailto:pichaya.phulphean@gmail.com).
